...
if __name__ == "__main__":
    ...
    dataset_name = "SciVQA_image_cdpruner"
...
#         outputs, batch_pruning_time = execute_batch_scivqa_with_pruned_embeddings(
#             modelname="/data/models/llava-1.5-7b-hf",
#             fields=fields_list,
#             query=prompt_template,
#             keep_ratio=keep_ratio,
...
#         # Calculate per-row pruning time
...
#         QA Type: {text:qa_pair_type}
#         Answer Options: {text:answer_options}
#         ', question, image_file, caption, figure_type, qa_pair_type, answer_options) as llm_result
#             FROM pope
#         """)
...
#     # Drop pruning_time before saving
#     result_df_final = result_df_with_comparison.drop("pruning_time")
