...
data = {
    ...
    'Accuracy': [60, 58, 60, 57, 49, 49, 52, 50, 56, 48, 48, 47, 35, 31, 28, 29],
    'Strategy': ['Pruned']*4 + ['Pruned + Opt1']*4 + ['Pruned+Opt2']*4 + ['Pruned+Opt2+Opt1']*4
}
...
ax2.set_title('Accuracy vs Token Preserve Percentage', fontsize=14, fontweight='bold')
