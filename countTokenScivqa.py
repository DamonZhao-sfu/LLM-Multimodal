...
def process_json_file_with_spark(model, vision_tower, tokenizer, json_path, 
    ...
    with open(output_csv, 'w', newline='') as csvfile:
        ...
        writer.writerow(['row_index', 'image_tokens', 'text_tokens', 'total_tokens', 'total_pixels', 'image_width', 'image_height'])
...
def process_parquet_file(model, vision_tower, tokenizer, parquet_path, 
                        image_column, text_columns, output_csv="token_counts.csv",
                        text_separator=" "):
    """Process parquet file (for POPE format with embedded images)."""
    # Read parquet file
